...
function LegacySettingsPage() {
  ...
  return (
    <div>
      <div className="mb-5">
        <h1 className="text-[30px] font-bold leading-[38px] tracking-[-0.6px] text-[#212B3A]">{t('settings.title')}</h1>
        <p className="mt-1 text-base text-[#44474C]">{t('settings.subtitle')}</p>
      </div>

      <div className="space-y-4">
        <section className="rounded-xl border border-[#C3C6D7] bg-white p-5">
          <h2 className="mb-4 text-lg font-semibold text-[#1F2937]">{t('settings.appearance')}</h2>
        ...
        <section className="rounded-xl border border-[#C3C6D7] bg-white p-5">
          <h2 className="mb-4 text-lg font-semibold text-[#1F2937]">{t('settings.language')}</h2>
